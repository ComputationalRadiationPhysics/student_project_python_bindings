...
phase_retrieval_pybind = cuPhaseRet.Phase_Algo(image, mask, 20, "hybrid", 0.8, array_random)
print(phase_retrieval_pybind.getMode())
print(phase_retrieval_pybind.getSteps())
print(phase_retrieval_pybind.getBeta())
