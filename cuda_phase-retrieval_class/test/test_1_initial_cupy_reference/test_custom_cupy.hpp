...
bool test_if_reinterpret_ptr_is_the_same(size_t a_address, Cupy_Ref<double> b)
{
...
bool test_if_custom_cupy_reinterpret_ptr_is_a_gpu_array(Cupy_Ref<double> b)
{
...
bool test_copy_custom_cupy_to_cpu(Cupy_Ref<double> b)
{
    int linear_size = 1;
...
bool custom_cupy_increment_all_data_by_1(Cupy_Ref<double> b) 
{
    int linear_size = 1;
    for(int const &s : b.shape) linear_size *= s;
...
Cupy_Ref<double> test_copy_custom_cupy_to_custom_cupy(Cupy_Ref<double> b)
{
    Cupy_Ref<double> c;
...
void test_wrong_dtype_float(Cupy_Ref<double> b){}

//test 14 : send wrong integer types
void test_wrong_dtype_int(Cupy_Ref<uint16_t> b){}

//test 15 : send wrong complex types
void test_wrong_dtype_complex(Cupy_Ref<std::complex<double>> b){}

//test 16 : template function with pybind11
template <typename T>
bool test_custom_cupy_template_function(size_t a_address, Cupy_Ref<T> b)
{
