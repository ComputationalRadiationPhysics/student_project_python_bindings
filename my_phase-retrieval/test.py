...
result_cuda_random =  cuPhaseRet.fienup_phase_retrieval(magnitudes, mask, 500, False, "hybrid", 0.8)
result_c_random =  cuPhaseRet.fienup_phase_retrieval_c_random(magnitudes, mask, 500, False, "hybrid", 0.8)
